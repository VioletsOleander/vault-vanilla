...
As it turns out pip requirements file have a construct to handle just such a case. Given a directory with a `setup.py` inside of it you can write a requirements file that looks like:
